...
public class Main {
    ...
    private static Pizza createPizza(String... pizzaArgs) throws IllegalArgumentException {
    ...
    private static Dough createDough(String... doughArgs) throws IllegalArgumentException {
    ...
    private static Topping createTopping(String... toppingArgs) throws IllegalArgumentException {
